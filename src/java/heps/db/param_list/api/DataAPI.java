...
import jpa.entities.Attribute;
import jpa.entities.Data;
import jpa.entities.Manager;
import jpa.entities.Parameter;
import jpa.entities.Reference;
import jpa.entities.Team;
import jpa.entities.Unit;
...
public class DataAPI {
    ...
    public void updateData(Data data, ParameterAPI p) {
        ...
        jpa.entities.System sys = em.createQuery("SELECT s FROM jpa.entities.System s WHERE s.name = :name", jpa.entities.System.class).setParameter("name", p.getSys()).getSingleResult();
        data.setSystem(sys);
    ...
    public void saveNewParameter(ParameterAPI p) {
        ...
        try {
            ...
            jpa.entities.System sys = new jpa.entities.System();
            sys.setName(p.getSys());
            try {
                jpa.entities.System parent_sys = em.createQuery("SELECT s FROM jpa.entities.System s WHERE s.name = :name", jpa.entities.System.class).setParameter("name", p.getParent_sys()).getSingleResult();
                sys.setParentid(parent_sys);
            } catch (NoResultException e21) {
                jpa.entities.System parent_sys = new jpa.entities.System();
